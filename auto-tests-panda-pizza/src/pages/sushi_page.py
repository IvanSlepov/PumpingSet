...
from src.pages.locators.sushi_page_locators import SushiPageLocators
...
class SushiPage(BasePage):
    def __init__(self, driver: Remote):
        """Initialize driver and objects to works with 'Sushi' page.
        :param driver: Remote
        """
        super().__init__(driver)
        self.product_list: list = []

    def go_to_sushi_page(self) -> None:
        """Method thar proceeds to the Sushi page.
        :return:None
        """
        self._driver.get(TestPages.PRODUCT_PAGE_SUSHI)
    ...
    def generate_product_list(self) -> list:
        ...
        """
        products: list = self._driver.find_elements(*SushiPageLocators.LOCATOR_SUSHI_SETS)
    ...
    def check_items_in_cart(self, time_to_wait=15) -> str:
        ...
        number_of_items_in_cart = WebDriverWait(self._driver, time_to_wait).until(
            EC.presence_of_element_located(CheckoutLocators.LOCATOR_NUMBER_OF_SUSHI_SET_ITEMS_IN_CART)
        )
...
class PropertyOfProduct:
    ...
    def get_name(self) -> str:
        ...
        :return: string
        """
        return self._product.find_element(*SushiPageLocators.LOCATOR_SUSHI_SET_NAME).text

    def click_add_to_cart(self) -> None:
        """Method that add item to the cart.
        :return:None
        """
        self._product.find_element(*SushiPageLocators.LOCATOR_ADD_TO_CART).click()
